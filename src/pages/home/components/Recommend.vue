    ...
    data () {
        return {
            recommendList: [{
                ...
                desc: '3D夜光森林——“MAG夜光森林”，全馆作品均运用超逼真3D错位绘画技术，融合现代夜光透视手法魔幻呈现。'
            }]
        }
    }
}
